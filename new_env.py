    ...
    def step(self, actions):
        ...
        for unit_id, action in actions_p1.items():
            ...
            if unit and unit["health"] > 0:
                rewards[0] += self._process_action(unit, self.player2["units"], action, is_player1=True)
        ...
        for unit_id, action in actions_p2.items():
            ...
            if unit and unit["health"] > 0:
                rewards[1] += self._process_action(unit, self.player1["units"], action, is_player1=False)
